...
// Seeds propios de Home, distintos de los usados en salón/detalle
const TICKER_ROWS = seededScores(4111, 7);
const TOP_ROWS = seededScores(9227, 5);
            ...
            <div className="ticker">
              {TICKER_ROWS.map((r, i) => (
                <div key={r.name + i} className="tick-row" style={{ animationDelay: (i * 60) + "ms" }}>
                  <span className="tk-p neon-cyan">{r.name}</span>
                  <span className="tk-mid">▸ {GAMES[i % GAMES.length].title}</span>
